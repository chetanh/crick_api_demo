...
public class AppInjector {
    ...
    public static void init(CricketDemoApplication cricketDemoApplication) {
        DaggerAppComponent.builder().application(cricketDemoApplication)
                .build().inject(cricketDemoApplication);

        cricketDemoApplication
